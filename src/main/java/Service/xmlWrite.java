...
public abstract class xmlWrite {
    ...
    static final String xmlPath = "C:\\Users\\koppa\\Desktop\\" +
            "MoviePicker\\src\\main\\java\\Resources\\movies.xml";

    //Reads xml to list and adds movie
    public static Movies unMarshaling() throws JAXBException {
        ...
        Movies movies = (Movies) jaxbUnmarshaller.unmarshal(new File(xmlPath));
    ...
    public static void marshaling(Movie movieToAdd) throws JAXBException {
        ...
        jaxbMarshaller.marshal(movies, new File(xmlPath));
    }
}
